        ...
        return (
            <div>
                <div
                    ...
                    id={`modal-${this.props.data.imdb_id}`}
                    tabIndex="1"
                    role="dialog"
                    aria-labelledby={`modalLabel-${this.props.data.imdb_id}`}
                    aria-hidden="true"
                >
                    <div className="modal-dialog modal-lg" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5
                                    className="modal-title block-ellipsis pl-3"
                                    id={`modalLabel-${this.props.data.imdb_id}`}
                                >
                                ...
                                <div className="row w-100">
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 pl-md-2 pl-lg-3">
                                        <button
                                            ...
                                            data-toggle="modal"
                                            data-target={`#modal-confirm-${this.props.data.imdb_id}`}
                                        >
                                            <Icon name="trash" />
                                            &nbsp;Delete
                                        </button>
                ...
                <div
                    ...
                    tabIndex="2"
                    role="dialog"
                    id={`modal-confirm-${this.props.data.imdb_id}`}
                >
